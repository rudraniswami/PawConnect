...
if (isset($_POST['add_animaladmin'])) {
    ...
    $file_type = finfo_file($finfo, $temp_image);
    ...
    if (!array_key_exists($file_type, $allowed_image_types)) {
    ...
    $extension = $allowed_image_types[$file_type];
    ...
    if (!$stmt) {
        ...
        /* Delete uploaded image if query preparation fails */
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        echo "<script>
                ...
                window.location='animaladd_success.php';
              </script>";
        ...
        /* Delete image if database insertion fails */
        ...
        die("Unable to add animal. Please try again.");
    }
